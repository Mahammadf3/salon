...
import styles from "../styles/Padicure.module.css"

export default function Padicure({handleBookNow}){
  ...
  return (
    <div className={styles.HairCut}>
      ...
      <div className={styles.bookNowDiv}>
        {isclicked?<form onMouseLeave={handleClick} onSubmit={handleSubmit} className={styles.form}>
